...
#endif /* if ( ( 0 + SSS_HAVE_APPLET_NONE + SSS_HAVE_APPLET_A71CH + SSS_HAVE_APPLET_A71CL + SSS_HAVE_APPLET_A71CH_SIM + SSS_HAVE_APPLET_SE05X_A + SSS_HAVE_APPLET_SE05X_B + SSS_HAVE_APPLET_SE05X_C + SSS_HAVE_APPLET_SE05X_L + SSS_HAVE_APPLET_SE051_UWB + SSS_HAVE_APPLET_AUTH + SSS_HAVE_APPLET_LOOPBACK ) > 1 ) */
...
#endif /* if ( ( 0 + SSS_HAVE_APPLET_NONE + SSS_HAVE_APPLET_A71CH + SSS_HAVE_APPLET_A71CL + SSS_HAVE_APPLET_A71CH_SIM + SSS_HAVE_APPLET_SE05X_A + SSS_HAVE_APPLET_SE05X_B + SSS_HAVE_APPLET_SE05X_C + SSS_HAVE_APPLET_SE05X_L + SSS_HAVE_APPLET_SE051_UWB + SSS_HAVE_APPLET_AUTH + SSS_HAVE_APPLET_LOOPBACK ) == 0 ) */
...
#endif /* if ( ( 0 + SSS_HAVE_SE05X_AUTH_NONE + SSS_HAVE_SE05X_AUTH_USERID + SSS_HAVE_SE05X_AUTH_PLATFSCP03 + SSS_HAVE_SE05X_AUTH_AESKEY + SSS_HAVE_SE05X_AUTH_ECKEY + SSS_HAVE_SE05X_AUTH_USERID_PLATFSCP03 + SSS_HAVE_SE05X_AUTH_AESKEY_PLATFSCP03 + SSS_HAVE_SE05X_AUTH_ECKEY_PLATFSCP03 ) > 1 ) */
...
#endif /* if ( ( 0 + SSS_HAVE_SE05X_AUTH_NONE + SSS_HAVE_SE05X_AUTH_USERID + SSS_HAVE_SE05X_AUTH_PLATFSCP03 + SSS_HAVE_SE05X_AUTH_AESKEY + SSS_HAVE_SE05X_AUTH_ECKEY + SSS_HAVE_SE05X_AUTH_USERID_PLATFSCP03 + SSS_HAVE_SE05X_AUTH_AESKEY_PLATFSCP03 + SSS_HAVE_SE05X_AUTH_ECKEY_PLATFSCP03 ) == 0 ) */
