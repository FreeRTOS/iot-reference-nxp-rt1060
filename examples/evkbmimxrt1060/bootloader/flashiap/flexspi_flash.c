...
/* Read */
    ...
    [ 4 * HYPERFLASH_CMD_LUT_SEQ_IDX_READDATA + 2 ] =
        FLEXSPI_LUT_SEQ( kFLEXSPI_Command_READ_DDR,                                                              kFLEXSPI_8PAD, 0x04,          kFLEXSPI_Command_STOP,           kFLEXSPI_1PAD, 0x0 ),
#endif /* if defined( ISSI_AT25SFxxxA ) || defined( ISSI_IS25LPxxxA ) || defined( ISSI_IS25WPxxxA ) || defined( WINBOND_W25QxxxJV ) */
...
#endif /* if defined( ISSI_AT25SFxxxA ) || defined( WINBOND_W25QxxxJV ) */
...
#endif /* if defined( ISSI_AT25SFxxxA ) || defined( ISSI_IS25LPxxxA ) */
...
/* Write Enable */
    ...
    [ 4 * HYPERFLASH_CMD_LUT_SEQ_IDX_WRITEENABLE + 7 ] =
        FLEXSPI_LUT_SEQ( kFLEXSPI_Command_DDR,                                                                   kFLEXSPI_8PAD, 0x00,          kFLEXSPI_Command_DDR,            kFLEXSPI_8PAD, 0x55 ),
#endif /* if defined( ISSI_AT25SFxxxA ) || defined( ISSI_IS25LPxxxA ) || defined( ISSI_IS25WPxxxA ) || defined( WINBOND_W25QxxxJV ) || defined( Macronix_MX25UM51345G ) || defined( Macronix_MX25UM51345G_2nd ) */
