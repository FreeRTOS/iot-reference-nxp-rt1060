...
static status_t flexspi_nor_flash_erase_sector( FLEXSPI_Type * base,
                                                uint32_t address )
{
    status_t status;
    flexspi_transfer_t flashXfer;
...
static status_t flexspi_nor_flash_page_program( FLEXSPI_Type * base,
                                                uint32_t dstAddr,
                                                const uint32_t * src,
                                                size_t len )
{
...
status_t flexspi_nor_write_enable( FLEXSPI_Type * base,
                                   uint32_t baseAddr,
                                   bool enableOctal )
{
    flexspi_transfer_t flashXfer;
...
status_t flexspi_nor_flash_erase_sector( FLEXSPI_Type * base,
                                         uint32_t address )
{
    status_t status;
    flexspi_transfer_t flashXfer;
...
status_t flexspi_nor_flash_program( FLEXSPI_Type * base,
                                    uint32_t dstAddr,
                                    const uint32_t * src,
                                    uint32_t length )
{
...
status_t flexspi_nor_hyperbus_read( FLEXSPI_Type * base,
                                    uint32_t addr,
                                    uint32_t * buffer,
                                    uint32_t bytes )
{
...
status_t flexspi_nor_flash_page_program( FLEXSPI_Type * base,
                                         uint32_t address,
                                         const uint32_t * src,
                                         size_t len )
{
...
status_t sbl_flash_write( uint32_t dstAddr,
                          const void * src,
                          size_t len )
{
    status_t status;
...
status_t sbl_flash_read( uint32_t dstAddr,
                         void * buf,
                         size_t len )
{
...
status_t sbl_flash_erase( uint32_t address,
                          size_t len )
{
    status_t status;
...
status_t sbl_flash_read_ipc( uint32_t address,
                             void * buffer,
                             size_t length )
{
    status_t status;
