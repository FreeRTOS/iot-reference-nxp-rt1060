...
uint8_t g_UsbDeviceConfigurationDescriptor[] = {
    ...
    */
    ...
    USB_LONG_GET_BYTE1(USB_DEVICE_CCID_SMART_CARD_MAX_IFSD),
    USB_LONG_GET_BYTE2(USB_DEVICE_CCID_SMART_CARD_MAX_IFSD),
...
uint8_t g_UsbDeviceString2[] = {
    ...
    ' ',          0x00U, // 7
    'v',          0x00U, // 8
	0x30 + (0x0F&(APPLET_SE050_VER_MAJOR / 10)), 0x00, // 9
	0x30 + (0x0F&(APPLET_SE050_VER_MAJOR % 10)), 0x00, // 10
	'.', 								  0x00, // 11
	0x30 + (0x0F&(APPLET_SE050_VER_MINOR / 10)), 0x00, // 12
	0x30 + (0x0F&(APPLET_SE050_VER_MINOR % 10)), 0x00, // 13
	'.', 								  0x00, // 14
	0x30 + (0x0F&(APPLET_SE050_VER_DEV / 10)),   0x00, // 15
	0x30 + (0x0F&(APPLET_SE050_VER_DEV % 10)),   0x00, // 16
};
#else
