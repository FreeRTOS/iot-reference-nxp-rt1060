...
#elif (SSS_HAVE_APPLET_SE05X_IOT)  || SSS_HAVE_A71CH /* SMARTCARD module is UART */
#define SMARTCARD_CONTROL(context, control, param)                                   \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, control, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_TRANSFER(context, xfer)                                               \
    SMARTCARD_SE05x_TransferNonBlocking(((smartcard_context_t *)context)->base, context, \
                                       xfer) /*!< Common Smart card API macro */
#define SMARTCARD_INIT(base, context, sourceClockHz) \
    SMARTCARD_SE05x_Init(base, context)      /*!< Common Smart card API macro */
#define SMARTCARD_DEINIT(base) SMARTCARD_SE05x_Deinit(base) /*!< Common Smart card API macro */
#define SMARTCARD_GET_TRANSFER_REMAINING_BYTES(context)                              \
    SMARTCARD_SE05x_GetTransferRemainingBytes(((smartcard_context_t *)context)->base, \
                                             context) /*!< Common Smart card API macro */
#define SMARTCARD_ABORT_TRANSFER(context) \
    SMARTCARD_SE05x_AbortTransfer(((smartcard_context_t *)context)->base, context) /*!< Common Smart card API macro */
#define SMARTCARD_CONFIG_BAUDRATE(context)                                                                \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_ConfigureBaudrate, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_SETUP_ATR(context)                                                                 \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_SetupATRMode, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_SETUP_T0(context)                                                                 \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_SetupT0Mode, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_SETUP_T1(context)                                                                 \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_SetupT1Mode, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_RESET_WWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_ResetWWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_RESET_CWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_ResetCWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_RESET_BWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_ResetBWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_WWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableWWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_CWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableCWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_BWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableBWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_DISABLE_WWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_DisableWWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_DISABLE_CWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_DisableCWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_DISABLE_BWT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_DisableBWT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_ADT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableADT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_DISABLE_ADT(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_DisableADT, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_SET_WTX(context, mWTX)                                                                        \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_ResetWaitTimeMultiplier, \
                           (uint32_t)mWTX) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_INIT_DETECT(context)                                                            \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableInitDetect, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_ANACK(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableAnack, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_DISABLE_ANACK(context)                                                             \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_DisableAnack, \
                           0) /*!< Common Smart card API macro */
#define SMARTCARD_ENABLE_RECEIVER(context)                                                                 \
    SMARTCARD_SE05x_Control(((smartcard_context_t *)context)->base, context, kSMARTCARD_EnableReceiverMode, \
                           0) /*!< Common Smart card API macro */
#else
#define SMARTCARD_CONTROL(context, control, param)                                   \
    SMARTCARD_UART_Control(((smartcard_context_t *)context)->base, context, control, \
                           0) /*!< Common Smart card API macro */
#define xSMARTCARD_TRANSFER(context, xfer)                                               \
...
#define xSMARTCARD_GET_TRANSFER_REMAINING_BYTES(context)                              \
...
#define SMARTCARD_PHY_INIT(base, config, sourceClockHz) \
    SMARTCARD_PHY_SE05x_Init(base, config)                           /*!< Common Smart card API macro */
...
#define BOARD_SMARTCARD_MODULE NULL
